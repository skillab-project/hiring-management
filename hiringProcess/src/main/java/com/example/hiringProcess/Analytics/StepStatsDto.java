...
public class StepStatsDto {
    private double passRate;                    // % υποψηφίων με avg score >= 5.0 (50%)
    private double avgStepScore;                // μέση βαθμολογία όλων των ερωτήσεων του step
    ...
    public double getAvgStepScore() { return avgStepScore; }
    public void setAvgStepScore(double avgStepScore) { this.avgStepScore = avgStepScore; }
    ...
    public List<QuestionAvgDto> getQuestionRanking() { return questionRanking; }
    public void setQuestionRanking(List<QuestionAvgDto> questionRanking) { this.questionRanking = questionRanking; }

    public List<SkillAvgDto> getSkillRanking() { return skillRanking; }
    public void setSkillRanking(List<SkillAvgDto> skillRanking) { this.skillRanking = skillRanking; }
}
