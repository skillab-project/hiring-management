package com.example.hiringProcess.SkillScoreService;
...
import com.example.hiringProcess.SkillScore.*;
...
//
//        List<SkillScoreResponseDTO> out = skillScoreService.listForCandidateQuestion(1, 2, 1);
//
...
//    }
    ...
    void upsert_whenCandidateMissing_throws() {
        ...
        IllegalStateException ex = assertThrows(IllegalStateException.class, () -> skillScoreService.upsert(dto, 1));
...
//
//        SkillScoreResponseDTO out = skillScoreService.upsert(dto, 1);
//
...
//        skillScoreService.deleteTuple(1, 2, 3, 1);
//
...
//
//        List<SkillScoreResponseDTO> out = skillScoreService.listAll(1);
//
...
//        when(mapper.toResponseDTO(s2)).thenReturn(d2);
//
//        List<SkillScoreResponseDTO> out = skillScoreService.listForQuestion(9, 1);
//
//        assertEquals(2, out.size());
//        assertSame(d1, out.get(0));
//        assertSame(d2, out.get(1));
